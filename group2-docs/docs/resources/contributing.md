---
lang: en-US
title: "Contributing to Openmadness"
...
Please open an [Issue](URL-to-issues) with:
...
PRs should reference related issues (e.g., “Fixes #123”) and include a helpful description. Expect review feedback and please respond positively to suggestions.
...
- Markdown files: follow [CommonMark](https://commonmark.org/) conventions
...
- 📄 Writing or improving documentation, tutorials
- 🎨 Enhancing design, layout, or UX
- 🧪 Creating examples or test cases
- 📢 Sharing Open Madness with others
